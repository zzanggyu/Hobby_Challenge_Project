...
```sql
# MySQL 데이터베이스 생성
CREATE DATABASE hobby_challenge CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
```
...
- **개발자**: 김현규
- **소속**: ITS사업부  
- **프로젝트 기간**: 2025.05.06 - 진행중
- **프로젝트 유형**: Term Project 2

### 연락처
- 개발 문의나 버그 리포트는 이슈로 등록해 주세요
