...
public enum ErrorCode {
    ...
    // S3 관련 에러 코드 
    S3_BUCKET_NOT_FOUND("500101", "파일 저장소를 찾을 수 없습니다."),
    S3_ACCESS_DENIED("403102", "파일 업로드 권한이 없습니다."),
    S3_INVALID_REQUEST("400103", "잘못된 파일 업로드 요청입니다."),
    S3_SLOW_DOWN("429104", "서버 과부하로 잠시 후 다시 시도해주세요."),
    S3_SERVICE_UNAVAILABLE("503105", "파일 저장 서비스가 일시적으로 사용할 수 없습니다."),
    S3_UPLOAD_FAILED("500106", "파일 업로드 중 오류가 발생했습니다."),

    // 네트워크 관련 에러 코드 
    NETWORK_ERROR("503201", "네트워크 연결에 문제가 있습니다."),
